...
const FAQ_ENTRIES = [
  ...
  { q: "übung neu starten restart exercise neustarten",
    a: "Klar! Tipp oben links auf den Zurück-Pfeil, dann wähl die Übung erneut — sie startet von vorne.",
    a_en: "Sure! Tap the back arrow top left, then reselect the exercise — it'll restart from the beginning.",
  ...
  { q: "übung verstehe ich nicht anleitung schwer schwierig",
    a: "Verstehe, geht vielen so! Tipp auf das Fragezeichen-Symbol für eine Anleitung. Frag auch deinen Therapeuten.",
    a_en: "Totally normal! Tap the question mark icon for instructions. You can also ask your therapist.",
  ...
  { q: "übung zu schwer zu leicht schwierigkeit level",
    a: "Verstehe! Die App passt sich automatisch an. Du kannst auch unter Einstellungen > Therapieplan ändern.",
    a_en: "Got it! The app adjusts automatically. You can also change it in Settings > Therapy Plan.",
  ...
  { q: "einstellungen settings finden wo",
    a: "Zahnrad-Symbol oben rechts im Dashboard — dort findest du Profil, Benachrichtigungen und Therapieplan.",
    a_en: "Gear icon at the top right of the dashboard — profile, notifications, and therapy plan are all there.",
  ...
  { q: "fortschritt sehen ergebnis statistik",
    a: "Im Dashboard findest du den Fortschrittsbereich — absolvierte Übungen, Entwicklung und Erfolge. Weiter so!",
    a_en: "In the dashboard you'll find the progress section — completed exercises, development, and achievements.",
